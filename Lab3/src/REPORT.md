...
1. Click "Add Paper" button in Browse Papers tab
2. Fill in the form:
   - Paper URL/Link (optional): `https://arxiv.org/abs/2024.12345`
   - Title: `Deep Learning Applications in Healthcare`
   - Author(s): `Dr. Sarah Chen, Prof. Michael Brown`
   - Abstract: `This paper explores...`
   - Keywords: `Deep Learning, Healthcare, AI`
   - Department: `Computer Science`
   - Year: `2024`
3. Click "Add Paper" to save

**Converting Papers with Adapter:**

1. Navigate to "Adapter Demo" tab
2. Select papers using checkboxes (e.g., select 2 papers)
3. Choose output format (e.g., "JSON")
4. Click "Convert 2 Paper(s) to JSON"
5. View the converted JSON output in the display area

**Applying Decorators:**

1. Navigate to "Decorator Demo" tab
2. Select a paper from the dropdown
3. Check desired decorators:
   - ✓ Include Citations
   - ✓ Include Peer Review
   - ✓ Include Formatting (select "Modern" style)
4. Click "Apply Decorators"
5. View the enhanced paper display in the preview pane
...
2. View statistics cards showing:
   ...
   - With Reviews: 1
   - Departments: 3
3. Scroll to see department list
...
2. Build the project: `./gradlew build` (or `.\gradlew build` on Windows)
3. Run the application: `./gradlew run` (or `.\gradlew run` on Windows)

Alternatively, use your IDE to run the `main()` function in `Main.kt`.

The application will launch a desktop window titled "University Research Management System" with a tabbed interface demonstrating all three structural design patterns.
